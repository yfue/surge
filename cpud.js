...
let blockKeyWords = ['思科','婚纱摄影', 'BMW情报站','尚德机构', '在职研究生报考','一站式服务', '拎包入住','拎包入驻', '购全新','资产配置', '买一送一','迅捷文字', '靓号','培训学校', '代理商','分销', '分红','花椒直播', '智能复合机','同一个应用', '点书','多重礼遇', '上市','汉语老师', '买花送','送错花', '安全报告','大流量', '不限速','BMW', '随便搜','培训机构', '服务器', '录音软件','语言翻译', '招生','学信网可查', 'GPA','普通大学本科', '有流量','有实力', '开盘','楼盘', '招商','深夜', '足迹','生成地图', '不信你试试','文字转成', '缺老婆','缺女朋友', '找我', '实时','不换号', '抢先体验','睡不着', '美女短视频','转文字', '电子日记','自律的人', '安全','阅读报告', '定制','网络安全', 'KTV','大叔', 'ktv','申请', '分期','借钱', '官网', '政企','美女直播', '动力','享', '门票', '免费','每人', '领取','优势', '铺开','换新', '新车','借钱', '借你','半价', '优惠','价格', '聊天','工资', '证书','半价', '加油','套房', '找我', '喜欢的人', '蓝军出击']
